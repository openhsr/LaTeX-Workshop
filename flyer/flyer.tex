...
\begin{document}
  ...
  \begin{itemize}
    \item[\faIcon{calendar-check}] 25. November, 17\textsuperscript{00} \~{} 19\textsuperscript{00}
  ...
  {\rmfamily\noindent
    ...
    It's \LaTeX{}'s default font, the standard typesetting tool in Academia!
    If you want your Bachelor thesis to look good, you have to learn \LaTeX{}!
  }

  \vspace{15mm}

  \begin{itemize}
    \item[\faIcon{users}] Targeted at beginner to intermediate users
    \item[\faIcon{comments}] Presentation + Help to get you started
    \item[\faIcon{flask}] Workshop content
      \begin{itemize}
        \item Absolute basics
