...
\begin{frame}{About me and polls}
  \begin{block}<1->{Me}
    \begin{itemize}
      \item BSc in Electrical Engineering, graduated here last year
      \item MSc in EE spec. Control Systems at ETH
    \end{itemize}
  \end{block}

  \begin{exampleblock}<2->{You}
    \begin{itemize}
      \item Faculty?
